...
const StaffHome = () => {
  ...
  function fetch_data() {
    axiosInstance
      .get("/announcement/admin/display-announcements")
      .then((res) => {
  ...
  useEffect(() => {
    axiosInstance
      .get("/student/assignedClass-count-student")
      .then((res) => {
  ...
  function send_pending_remainder() {
    axiosInstance
      .put("/student/fee-status-pending")
      .then((res) => {
  ...
  function fetch_studentData(){
    axiosInstance.get('/student/staff-students-fee-status').then((res)=>{
